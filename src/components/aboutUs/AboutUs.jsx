        ...
        <div className="main-about-us">
            <div className="container-about-us">
                ...
                <div className="exemplos">
                    <div className="ex1">
                        <FontAwesomeIcon icon={faUsers} beat className="icon-user" /> <h4 className="titulo1">700 Mil</h4>
                        <label htmlFor="text">Agendamentos por dia</label>
                    </div>

                    <div className="ex2">
                        <FontAwesomeIcon icon={faChartLine} beat className="icon-chart" /> <h4 className="titulo2">Foco no Crescimento</h4>
                        <label htmlFor="text">Ferramentas e insights para expandir seu negócio.</label>
                    </div>

                    <div className="ex3">
                        <FontAwesomeIcon icon={faClockRotateLeft} beat className="icon-clock" /> <h4 className="titulo3">Rapidez e Eficiência</h4>
